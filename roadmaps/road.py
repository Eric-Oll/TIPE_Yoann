...
class Road(object): # Même que "class Road():" ou "class Road:"
    ...
    def __init__(self, x_interval, y_interval, path_functions, step:int=None):
        """
        :param x_interval: Intervalle de calcul (x_start, x_end)
        :param y_interval: Intervalle de calcul (y_start, y_end)
        :param path_functions: Fonctions paramétriques (x_func, y_func)
